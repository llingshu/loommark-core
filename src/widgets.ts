...
// KaTeX's own stylesheet is a separate, explicit import (see style.css) rather than a hidden
// side effect of importing this module — a host needs to load it once regardless of how many of
// this package's modules it pulls in, so it isn't tucked away inside one widget's source file.
